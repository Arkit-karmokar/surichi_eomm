<?php 
    ...
    include('conn.php');
    $id=$_GET['id'];
    $select_product_details=$conn->query("SELECT *FROM products WHERE md5(ID)='$id'");
    $fetch_product_details=mysqli_fetch_array($select_product_details);
    $discount=$fetch_product_details['Discount'];
    $name=$fetch_product_details['Product_Name'];
    $price=$fetch_product_details['Product_Price'];
    $discounted=$price*$discount/100;
    $selling_price=$price-$discounted;
                        ...
                        <div class="product__details--media">
                            <div class="product__media--preview  swiper">
                                <div class="swiper-wrapper">
                                    <?php 
                                        $select_banner=$conn->query("SELECT *FROM banner WHERE md5(ID)='$id'");
                                       $fetch_banner=$select_banner->fetch_array();
                                     ?>
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/banner/<?=$fetch_banner['Banner_1'];?>"><img class="product__media--preview__items--img" src="assets/img/banner//<?=$fetch_banner['Banner_1'];?>" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="assets/img/banner/<?php echo $fetch_banner['Banner_1'];?>" data-gallery="product-media-preview">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/banner/<?=$fetch_banner['Banner_2'];?>"><img class="product__media--preview__items--img" src="assets/img/banner/<?=$fetch_banner['Banner_2'];?>" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="assets/img/banner/<?=$fetch_banner['Banner_2'];?>" data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/banner/<?=$fetch_banner['Banner_3'];?>"><img class="product__media--preview__items--img" src="assets/img/banner/<?=$fetch_banner['Banner_3'];?>" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="assets/img/banner/<?=$fetch_banner['Banner_3'];?>" data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/banner/<?=$fetch_banner['Banner_4'];?>"><img class="product__media--preview__items--img" src="assets/img/banner/<?=$fetch_banner['Banner_4'];?>" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="assets/img/banner/<?=$fetch_banner['Banner_4'];?>" data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/banner/<?=$fetch_banner['Banner_5'];?>"><img class="product__media--preview__items--img" src="assets/img/banner/<?=$fetch_banner['Banner_5'];?>" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="assets/img/banner/<?=$fetch_banner['Banner_5'];?>" data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="product__media--preview__items">
                                            <a class="product__media--preview__items--link glightbox" data-gallery="product-media-preview" href="assets/img/banner/<?=$fetch_banner['Banner_6'];?>"><img class="product__media--preview__items--img" src="assets/img/banner/<?=$fetch_banner['Banner_6'];?>" alt="product-media-img"></a>
                                            <div class="product__media--view__icon">
                                                <a class="product__media--view__icon--link glightbox" href="assets/img/banner/<?=$fetch_banner['Banner_6'];?>" data-gallery="product-media-preview">
                                                    <svg class="product__media--view__icon--svg" xmlns="http://www.w3.org/2000/svg" width="22.51" height="22.443" viewBox="0 0 512 512"><path d="M221.09 64a157.09 157.09 0 10157.09 157.09A157.1 157.1 0 00221.09 64z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"></path><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-miterlimit="10" stroke-width="32" d="M338.29 338.29L448 448"></path></svg>
                                                </a>
                                            </div>
                                        </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img img_width" src="assets/img/banner/<?php echo $fetch_banner['Banner_1'];?>" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img img_width" src="assets/img/banner/<?php echo $fetch_banner['Banner_2'];?>" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="assets/img/banner/<?php echo $fetch_banner['Banner_3'];?>" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="assets/img/banner/<?php echo $fetch_banner['Banner_4'];?>" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="assets/img/banner/<?php echo $fetch_banner['Banner_5'];?>" alt="product-nav-img">
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="product__media--nav__items">
                                            <img class="product__media--nav__items--img" src="assets/img/banner/<?php echo $fetch_banner['Banner_6'];?>" alt="product-nav-img">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="product__details--info">
                            <form action="#">
                                ...
                                <div class="product__details--info__price mb-10">
                                    ...
                                    <span class="current__price">&#8377; <?=$selling_price;?></span>
                                </div>
                                ...
                                <p class="product__details--info__desc mb-15"><?=$fetch_product_details['Descriptions'];?></p>
                                <div class="product__variant">
                                    <div class="product__variant--list mb-10">
                                        <fieldset class="variant__input--fieldset">
                                            <legend class="product__variant--title mb-8">Color :<?=$fetch_product_details['Product_Color'];?></legend>
                                    ...
                                    <div class="product__variant--list quantity d-flex align-items-center mb-20">
                                        ...
                                        <a href="cartAction.php?action=addToCart&&id=<?=$fetch_product_details['ID'];?>" class="quickview__cart--btn primary__btn" type="submit">Add To Cart</a> 
                                    </div>
                                    <div class="product__variant--list mb-15">
                                        ...
                                        <a href="cartAction.php?action=addToCart&&id=<?=$fetch_product_details['ID'];?>" class="variant__buy--now__btn primary__btn" type="submit">Buy it now</a>
                                    </div>
        ...
        <section class="product__section product__section--style3 section--padding">
            <div class="container product3__section--container">
                ...
                <div class="product__section--inner product__swiper--column4__activation swiper">
                    <div class="swiper-wrapper">
                        <?php
                        //echo "SELECT * FROM `categories` INNER JOIN `products` ON .Categories_ID=categories.ID WHERE md5(products.Categories_ID)<>'$id'";
                            //$select_not_current=mysqli_query($conn,"SELECT *FROM products INNER JOIN categories ON categories.ID=products.Categories_ID WHERE md5(products.ID)!='$id'");
                             $select_not_current=mysqli_query($conn,"SELECT * FROM products WHERE md5(ID)<>'$id'");
                                
                            while($fetch_not_current=mysqli_fetch_array($select_not_current)){
                        ?>
                        <div class="swiper-slide">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.php?id=<?php echo md5($fetch_not_current['ID']);?>">
                                        <img class="product__items--img product__primary--img" src="assets/img/product/<?=$fetch_not_current['Product_Image'];?>" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="assets/img/product/<?=$fetch_not_current['Product_Image_2'];?>" alt="product-img">
                                    </a>
                                ...
                                <div class="product__items--content">
                                    <span class="product__items--content__subtitle"><?php//$fetch_category_not['Category_Name'];?></span>
                                    <h3 class="product__items--content__title h4"><a href="product-details.php?id=<?=md5($fetch_not_current['ID']);?>"><?=$fetch_not_current['Product_Name'];?></a></h3>
                                    ...
                                    <ul class="product__items--action d-flex">
                                        <li class="product__items--action__list">
                                            <a class="product__items--action__btn add__to--cart" href="cartAction.php?action=addToCart&&id=<?=$fetch_not_current['ID'];?>">
