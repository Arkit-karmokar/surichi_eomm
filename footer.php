    ...
    <footer class="footer__section bg__black">
        <div class="container-fluid">
            ...
            <div class="footer__bottom d-flex justify-content-between align-items-center">
                <p class="copyright__content text-ofwhite m-0">Copyright &copy; <?php echo date('Y');?> <a class="copyright__content--link" href="index.html">Webinor</a> . All Rights Reserved.Design By Shubham Rana</p>
