...
#Start with slug url coding here in php
$url = explode('/', $_SERVER['QUERY_STRING']);
 //print_r($URL);
 $custom_url = $url[0];

 // ----- fetching store custom url's -----

  $services_query = "SELECT ID, Slug_url FROM blogs WHERE Slug_Url <> ''";
    $services_query_commit = mysqli_query($conn, $services_query);
    
    $cnt=0;
    while ($ress = mysqli_fetch_assoc($services_query_commit)) {
      
        $service_custom_url[$cnt] = $ress['Slug_url'];
        $cnt++;
    }

if (in_array(@$custom_url, $service_custom_url)) {
    require('blog-details.php');
    exit();
}
#end with slug url coding here in php
?>
<!doctype html>
<html lang="zxx">
<head>
  <meta charset="utf-8">
  <title>Webinor - Fashion eCommerce</title>
        ...
        <section class="product__section section--padding pt-0">
            <div class="container-fluid">
                ...
                <ul class="product__tab--one product__tab--primary__btn d-flex justify-content-center mb-50">
                    <li class="product__tab--primary__btn__list active" data-toggle="tab" data-target="#featured">i-Phone </li>
                    <li class="product__tab--primary__btn__list" data-toggle="tab" data-target="#trending">Android</li>
                ...
                <div class="tab_content">
                    <div id="featured" class="tab_pane active show">
                        <div class="product__section--inner">
                            <div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n30">
                                <?php
                                    $select_product=mysqli_query($conn,"SELECT *FROM products WHERE Sub_Categories_ID='9'");
                                    while ($fetch_product=$select_product->fetch_array()) {
                                    $subcategory=$fetch_product['Sub_Categories_ID'];
                                        $select_product_sub=mysqli_query($conn,"SELECT *FROM sub_categories WHERE ID='$subcategory'");
                                        $fetch_subcategory_product=$select_product_sub->fetch_array();
                                ?>
                                <div class="col mb-30">
                                    <div class="product__items">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="product-details.php?id=<?=md5($fetch_product['ID']);?>">
                                                <img class="product__items--img product__primary--img" src="assets/img/product/<?=$fetch_product['Product_Image'];?>" alt="product-img" class="img-fluid">
                                                <img class="product__items--img product__secondary--img" src="assets/img/product/<?=$fetch_product['Product_Image_2'];?>" alt="product-img" class="img-fluid">
                                            </a>
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle"><?=$fetch_subcategory_product['SubCategory_Name'];?></span>
                                            <h3 class="product__items--content__title h4"><a href="product-details.php?id=<?=md5($fetch_product['ID']);?>"><?=$fetch_product['Product_Name'];?></a></h3>
                                            <div class="product__items--price">
                                                <span class="old__price">&#8377; <?=number_format($fetch_product['Product_Price'],2);?></span>
                                                ...
                                                <span class="current__price">&#8377;
                                                    <?php
                                                        ...
                                                        echo number_format($selling_price,2);
                                                    ?>
                                                </span>
                                            </div>
                                            ...
                                            <ul class="product__items--action d-flex">
                                                <li class="product__items--action__list">
                                                    <a class="product__items--action__btn add__to--cart" href="cartAction.php?action=addToCart&id=<?php echo $fetch_product["ID"];?>">
                    ...
                    <div id="trending" class="tab_pane">
                        <div class="product__section--inner">
                            <div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n30">
                                <?php
                                    $select_product=mysqli_query($conn,"SELECT *FROM products WHERE Sub_Categories_ID='10'");
                                    while ($fetch_product=$select_product->fetch_array()) {
                                    $subcategory=$fetch_product['Sub_Categories_ID'];
                                        $select_product_sub=mysqli_query($conn,"SELECT *FROM sub_categories WHERE ID='$subcategory'");
                                        $fetch_subcategory_product=$select_product_sub->fetch_array();
                                ...
                                <div class="col mb-30">
                                    <div class="product__items ">
                                        <div class="product__items--thumbnail">
                                            <a class="product__items--link" href="product-details.php?id=<?=md5($fetch_product['ID']);?>">
                                                <img class="product__items--img product__primary--img" src="assets/img/product/<?=$fetch_product['Product_Image'];?>" alt="product-img">
                                                <img class="product__items--img product__secondary--img" src="assets/img/product/<?=$fetch_product['Product_Image_2'];?>" alt="product-img">
                                            </a>
                                            <div class="product__badge">
                                                <span class="product__badge--items sale">Sale</span>
                                            </div>
                                        ...
                                        <div class="product__items--content">
                                            <span class="product__items--content__subtitle"><?=$fetch_subcategory_product['SubCategory_Name'];?></span>
                                            <h4 class="product__items--content__title"><a href="product-details.php?id=<?=md5($fetch_product['ID']);?>"><?=$fetch_product['Product_Name'];?></a></h4>
                                            <div class="product__items--price">
                                                <span class="old__price"><?=$fetch_product['Product_Price'];?></span>
                                                <span class="price__divided"></span>
                                                <span class="current__price">
                                                    <?php
                                                        $discount=$fetch_product['Discount'];
        ...
        <section class="blog__section section--padding pt-0">
            <div class="container-fluid">
                ...
                <div class="blog__section--inner blog__swiper--activation swiper">
                    <div class="swiper-wrapper">
                        <?php 
                            $select_blog=$conn->query("SELECT *FROM blogs");
                            while($fetch_blog=$select_blog->fetch_assoc()){
                         ?>
                        <div class="swiper-slide">
                            <div class="blog__items">
                                <div class="blog__thumbnail">
                                    <a class="blog__thumbnail--link" href="<?=$fetch_blog['Slug_Url'];?>"><img class="blog__thumbnail--img" src="assets/img/blog/<?php echo $fetch_blog['Blog_Images'];?>" alt="blog-img"></a>
                                </div>
                                <div class="blog__content">
                                    <span class="blog__content--meta"><?php echo date('d-m-Y H:i:s',strtotime($fetch_blog['Create_Date']));?></span>
                                    <h3 class="blog__content--title"><a href="<?=$fetch_blog['Slug_Url'];?>"><?=$fetch_blog['Title'];?></a></h3>
                                    <a class="blog__content--btn primary__btn" href="<?=$fetch_blog['Slug_Url'];?>">Read more </a>
                                </div>
                            </div>
                        </div>
                        <?php }?>
