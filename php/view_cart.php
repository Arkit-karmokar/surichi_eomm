...
<!-- Mirrored from risingtheme.com/html/suruchi-demo/suruchi/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 31 Jul 2022 04:41:14 GMT -->
<head>
  <meta charset="utf-8">
                        ...
                        <div class="row">
                            ...
                            ?>
                                            ...
                                            <tr class="cart__table--body__items">
                                                <td class="cart__table--body__list">
                                                    <div class="cart__product d-flex align-items-center">
                                                        ...
                                                        <div class="cart__content">
                                                            <h4 class="cart__content--title"><a href="#"><?php echo $item["name"]; ?></a></h4>
                                                ...
                                                <td class="cart__table--body__list">
                                                    <span class="cart__price end"><?php echo $item["price"]*$item["qty"]; ?></span>
                                                </td>
                                            </tr>
                                        ...
                                        <table class="cart__summary--total__table">
                                            <tbody>
                                                <tr class="cart__summary--total__list">
                                                    ...
                                                    <td class="cart__summary--amount text-right"><?php echo $cart->total(); ?></td>
                                                </tr>
                                                <tr class="cart__summary--total__list">
