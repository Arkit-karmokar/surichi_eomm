            ...
            <div class="container-fluid">
                ...
                <div class="tab_content">
                    <?php
                        ...
                        $discount_amount=$fetch['Product_Price']*$discount/100;
                        $newprice=$fetch['Product_Price']-$discount_amount;
                    ?>
                                ...
                                <div class="col mb-30">
                                    <div class="product__items ">
                                        ...
                                        <div class="product__items--content">
                                            ...
                                            <h3 class="product__items--content__title h4"><a href="product-details.html"><?=$fetch['Product_name'];?></a></h3>
                                            <div class="product__items--price">
                                                <span class="current__price">&#x20B9;<?=number_format($newprice,2);?></span>
                                                <span class="price__divided"></span>
                                                <span class="old__price">&#x20B9;<?=$fetch['Product_Price'];?></span>
                                            </div>
                                            ...
                                            <ul class="product__items--action d-flex">
                                                <li class="product__items--action__list">
                                                    <a class="product__items--action__btn add__to--cart" href="cartAction.php?action=addToCart&id=<?php echo $fetch["ID"]; ?>">
...
<!-- Mirrored from risingtheme.com/html/suruchi-demo/suruchi/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 31 Jul 2022 04:40:21 GMT -->
</html>