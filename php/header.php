                        ...
                        <ul class="d-flex">
                            ...
                            <li class="header__account--items">
                                <a class="header__account--btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                                    ...
                                    <span class="items__count"><?php echo $cart->total_items();?></span> 
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul class="d-flex">
                            ...
                            <li class="header__account--items header__account2--items">
                                <a class="header__account--btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                                    ...
                                    <span class="items__count style2"><?php echo $cart->total_items();?></span> 
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <nav class="header__menu--navigation">
                            <ul class="d-flex">
                                <?php 
                                   ...
                                   $select_sub=$conn->query("SELECT *FROM sub_category WHERE Category_id='$category_id'");
                                $numrows=mysqli_num_rows($select_sub);  
                                ?>
                               <li class="header__menu--items">
                                    <a class="header__menu--link text-white" href="shop.php?catid=<?php echo $fetch['ID'];?>"><?=$fetch['Category_name'];?> 
                                            <?php 
                                           if ($numrows>0) {
                                    ...
                                    <ul class="header__sub--menu">
                                      <?php
                                    while ($fetch_sql=mysqli_fetch_array($select_sub)) {
                                        ?>
                                        <li class="header__sub--menu__items"><a href="shop.php?subcatid=<?php echo $fetch_sql['ID'];?>" class="header__sub--menu__link"><?=$fetch_sql['Sub_category_name'];?></a></li>
                                        <?php }?>
                                    </ul>
                                        <?php } ?>
                                </li>
            ...
            <ul class="d-flex justify-content-between">
                ...
                <li class="offcanvas__stikcy--toolbar__list">
                    <a class="offcanvas__stikcy--toolbar__btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                        ...
                        <span class="items__count"><?php echo $cart->total_items();?>
