<?php include('conn.php');
    ...
    if (!empty($cat_id) && empty($subcat_id)) {
        $categorey_id=$_GET['catid'];
         $sql="Category_ID='$categorey_id'";
    }elseif(empty($cat_id) && !empty($subcat_id)){
   $subcatid=$_GET['subcatid'];
   $sql="Sub_Category_ID='$subcatid'";
    }
?>
<!doctype html>
<html lang="zxx">
...
<head>
  <meta charset="utf-8">
  <title>Suruchi - Shop Left Sidebar</title>
                                ...
                                <div id="product_grid" class="tab_pane active show">
                                    <div class="product__section--inner product__grid--inner">
                                        <div class="row row-cols-xl-4 row-cols-lg-3 row-cols-md-3 row-cols-2 mb--n30">
                                            <?php 
                                                $select_all=$conn->query("SELECT *FROM product WHERE $sql");
                                                    while ($fetchdata=$select_all ->fetch_assoc()) {
                                            ...
                                            <div class="col mb-30">
                                                <div class="product__items ">
                                                    <div class="product__items--thumbnail">
                                                        <a class="product__items--link" href="product-details.html">
                                                            <img class="product__items--img product__primary--img" src="assets/img/product/<?php echo $fetchdata['Product_Image'];?>" alt="product-img">
                                                            <img class="product__items--img product__secondary--img" src="assets/img/product/<?php echo $fetchdata['Small_image2'];?>" alt="product-img">
                                                        </a>
                                                    ...
                                                    <div class="product__items--content">
                                                        ...
                                                        <h3 class="product__items--content__title h4"><a href="product-details.html"><?=$fetchdata["Product_name"];?></a></h3>
                                                        <div class="product__items--price">
                                                            <span class="current__price"><?php  
                                                            $discount=$fetchdata['Discount'];
                                                            $discount_amount=$fetchdata['Product_Price']*$discount/100;
                                                           echo $newprice=number_format($fetchdata['Product_Price']-$discount_amount,2);

                                                            ?>
                                                            
                                                        </span>
                                                            <span class="price__divided"></span>
                                                            <span class="old__price"><?=$fetchdata['Product_Price'];?></span>
                                                        </div>
                                                        <ul class="rating product__rating d-flex">
                                                            <li class="rating__list">
                                                                <span class="rating__list--icon">
...
<!-- Mirrored from risingtheme.com/html/suruchi-demo/suruchi/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 31 Jul 2022 04:41:02 GMT -->
</html>