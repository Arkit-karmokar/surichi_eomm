            ...
            <div class="container-fluid">
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="index.php"><img class="main__logo--img" src="assets/img/logo/nav-log.png" alt="logo-img"></a></h1>
                    </div>
                    ...
                    <div class="header__account header__sticky--none">
                        <ul class="d-flex">
                            ...
                            <li class="header__account--items">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"  width="26.51" height="23.443" viewBox="0 0 512 512"><path d="M344 144c-3.92 52.87-44 96-88 96s-84.15-43.12-88-96c-4-55 35-96 88-96s92 42 88 96z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"/><path d="M256 304c-87 0-175.3 48-191.64 138.6C62.39 453.52 68.57 464 80 464h352c11.44 0 17.62-10.48 15.65-21.4C431.3 352 343 304 256 304z" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"/></svg> 
                                <span class="header__account--btn__text">Sign In</span>
                                </a>
                            </li>
                            <?php }?>
                            ...
                            <li class="header__account--items">
                                <a class="header__account--btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                                    ...
                                    <!-- How to add cart items in my cart -->  
                                    <span class="items__count"><?php echo ($cart->total_items() > 0)?$cart->total_items().' ':'0';?></span> 
                                </a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <ul class="d-flex">
                            ...
                            <li class="header__account--items header__account2--items">
                                <a class="header__account--btn minicart__open--btn" href="javascript:void(0)" data-offcanvas>
                                    ...
                                    <!-- How to add cart items in my cart -->
                                    <span class="items__count style2"><?php echo ($cart->total_items() > 0)?$cart->total_items().' ':'0';?></span>
                        ...
                        <li class="offcanvas__menu_li">
                            ...
                            <ul class="offcanvas__sub_menu">
                                ...
                                <li class="offcanvas__sub_menu_li">
                                    ...
                                    <ul class="offcanvas__sub_menu">
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="product-details.php?id=<?=md5($item['id']);?>">Product Details</a></li>
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="product-video.html">Video Product</a></li>
                                        <li class="offcanvas__sub_menu_li"><a class="offcanvas__sub_menu_item" href="product-details.php?id=<?=md5($item['id']);?>">Variable Product</a></li>
            ...
            <div class="minicart__product">
                ...
                <div class="minicart__product--items d-flex">
                    <div class="minicart__thumb">
                        <a href="product-details.php?id=<?=md5($item['id']);?>"><img src="assets/img/product/<?=$item['image'];?>" alt="prduct-img"></a>
                    </div>
                    <div class="minicart__text">
                        <h3 class="minicart__subtitle h4"><a href="product-details.php?id=<?=md5($item['id']);?>">Oversize Cotton Dress</a></h3>
                        <span class="color__variant"><b>Color:</b><?=$item['colour'];?></span>
                        ...
                        <div class="minicart__text--footer d-flex align-items-center">
                            <div class="quantity__box minicart__quantity">
                                ...
                                <label>
                                    <input type="number" class="quantity__number" id="quanties<?php echo $item["rowid"];?>" onchange="updateCart('<?php echo $item["rowid"];?>')" value="<?php echo $item["qty"];?>" data-counter />
                                </label>
                                <button type="button" class="quantity__value increase"  value="Increase Value">+</button>
                            </div>
                            <button class="minicart__product--remove" onclick="return confirm('Are you sure?')?window.location.href='cartAction.php?action=removeCartItem&id=<?php echo $item["rowid"];?>':false;">Remove</button>
                        </div>
                    </div>
                </div>
                <?php } }else{ ?>
