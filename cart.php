...
<body>
                                            ...
                                            <tr class="cart__table--body__items">
                                                <td class="cart__table--body__list">
                                                    <div class="cart__product d-flex align-items-center">
                                                        ...
                                                        <button class="cart__remove--btn" aria-label="search button" type="button" onclick="return confirm('Are you sure?')?window.location.href='cartAction.php?action=removeCartItem&id=<?php echo $item["rowid"];?>':false;">
                                                            <svg fill="currentColor" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" width="16px" height="16px"><path d="M 4.7070312 3.2929688 L 3.2929688 4.7070312 L 10.585938 12 L 3.2929688 19.292969 L 4.7070312 20.707031 L 12 13.414062 L 19.292969 20.707031 L 20.707031 19.292969 L 13.414062 12 L 20.707031 4.7070312 L 19.292969 3.2929688 L 12 10.585938 L 4.7070312 3.2929688 z"/></svg>
                                                        </button>
                                                        <!-- Removing item from cart end-->
                                                        <div class="cart__thumbnail">
                                                            <a href="product-details.php?id=<?=md5($item['id']);?>"><img class="border-radius-5" src="assets/img/product/<?=$item['image'];?>" alt="cart-product"></a>
                                                        </div>
                                                        <div class="cart__content">
                                                            <h4 class="cart__content--title"><a href="product-details.php?id=<?=md5($item['id']);?>"><?=$item['name']?></a></h4>
                                                            <span class="cart__content--variant">Colour:<?=$item['colour'];?></span>
                                                ...
                                                <td class="cart__table--body__list">
                                                    <div class="quantity__box">
                                                        ...
                                                        <label>
                                                            <input type="number" id="qty<?php echo $item["rowid"];?>" class="quantity__number quickview__value--number"  onchange="updateCartItem('<?php echo $item["rowid"];?>')" value="<?php echo $item["qty"];?>" data-counter/>
                                                        </label>
                                                        <button type="button" class="quantity__value quickview__value--quantity increase" aria-label="quantity value" value="Increase Value">+</button>
                                                    </div>
                                                </td>
                                                <td class="cart__table--body__list">
                                                    <span class="cart__price end"><?=$item['price']*$item['qty'];?></span>
                                                </td>
                                            </tr>
                                            <?php } }else{ ?>
                                            <tr>
                                        ...
                                        <table class="cart__summary--total__table">
                                            <tbody>
                                                ...
                                                <tr class="cart__summary--total__list">
                                                    ...
                                                    <td class="cart__summary--amount text-right">&#8377; <?=$cart->total();?></td>
                                                </tr>
                                                <tr class="cart__summary--total__list">
            ...
            <div class="container-fluid">
                ...
                <div class="product__section--inner product__swiper--activation swiper">
                    <div class="swiper-wrapper">
                        <?php 
                            $select_newproduct=$conn->query("SELECT * FROM products WHERE ID!='$id'");
                            while ($fetch_new_product=$select_newproduct->fetch_array()) {
                                $image=$fetch_new_product['Product_Image'];

                        ?>
                        <div class="swiper-slide">
                            <div class="product__items ">
                                <div class="product__items--thumbnail">
                                    <a class="product__items--link" href="product-details.php?id=<?=md5($fetch_new_product['ID']);?>">
                                        <img class="product__items--img product__primary--img" src="assets/img/product/<?=$image;?>" alt="product-img">
                                        <img class="product__items--img product__secondary--img" src="assets/img/product/<?=$fetch_new_product['Product_Image_2'];?>" alt="product-img">
                                    </a>
                                ...
                                <div class="product__items--content">
                                    <span class="product__items--content__subtitle"><?php echo $fetch_new_product['Product_Color'];?></span>
                                    <h3 class="product__items--content__title h4"><a href="product-details.php?id=<?=md5($fetch_new_product['ID']);?>"><?=$fetch_new_product['Product_Name'];?></a></h3>
                                    ...
                                    <ul class="product__items--action d-flex">
                                        <li class="product__items--action__list">
                                            <a class="product__items--action__btn add__to--cart" href="cartAction.php?action=addToCart&&id=<?=$fetch_new_product['ID'];?>">
  ...
  <script type="text/javascript">
    ...
    function updateCart(id){
        // alert(id);  
        var qty=$("#quanties"+id).val();
        alert(qty); 
        $.get("cartAction.php", {action:"updateCartItem", id:id, qty:qty}, function(data1){
            window.location.reload();
            if(data1 == 'ok'){
                location.reload();
            }else{
