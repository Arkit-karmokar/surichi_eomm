                ...
                <div class="main checkout__mian">
                    ...
                    <main class="main__content_wrapper">
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $date=date('Y-m-d');
                            $insert="INSERT INTO create_order_list(Name,Email,Mobile,City,Address,Zip_Code,Total_Amount,Payment_Type,Create_Date)VALUES('$name','$email','$mobile','$city','$address','$zip','$total_amount','$payment_method','$date')";
                            $invid="7830010";
                            $insert_sql=$conn->query($insert);
                            $inserid=$conn -> insert_id;
                            $order_id= $invid.$inserid;
                            $envid="GST/2022-23/0";
                            $invoice_no= $envid.$inserid;
                            echo  $update="UPDATE create_order_list SET Order_ID='$order_id',Invoice_ID='$invoice_no' WHERE ID='$inserid'";
                            $update_sql=$conn->query($update);
                            $cartItems = $cart->contents();
                            $sql = ''; 
                            foreach($cartItems as $item){ 
                                $place_order .= "INSERT INTO order_item (Order_ID, Product_ID, Qty,Amount) VALUES ('".$order_id."', '".$item['id']."', '".$item['qty']."','".$item['price']."');";
                                }  // Insert order items in the database 
                                $insertOrderItems = $conn->multi_query($place_order); 
                                if($insertOrderItems){ 
                                    // Remove all items from cart 
                                    $cart->destroy(); 
                                    echo '<strong>Order Id-'.$order_id.' </strong>
                                    </div>';
                                    $_SESSION['orderrrr_id']=$order_id;
                        ...
                        <form method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 mb-12">
                                            <div class="checkout__input--list ">
                                                <label>
                                                    <input class="checkout__input--field border-radius-5" placeholder="Full Name"  type="text" name="name">
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 mb-12">
                                            <div class="checkout__input--list">
                                                <label>
                                                    <input class="checkout__input--field border-radius-5" placeholder="Mobile"  type="number" name="mobile">
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-12 mb-12">
                                            <div class="checkout__input--list">
                                                <label>
                                                    <input class="checkout__input--field border-radius-5" placeholder="Email"  type="email" name="email" value="<?php if(!empty($_SESSION['useremail'])){ echo $_SESSION['useremail'];} ?>">
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-12 mb-12">
                                            <div class="checkout__input--list">
                                                <label>
                                                    <input class="checkout__input--field border-radius-5" placeholder="Full Address"  type="text" name="address">
                                                </label>
                                            </div>
                                        </div>
                                        <div class="col-12 mb-12">
                                        ...
                                        <div class="col-lg-6 mb-12">
                                            <div class="checkout__input--list checkout__input--select select">
                                                <select class="checkout__input--select__field border-radius-5" name="payment_method">
                                        ...
                                        <div class="col-lg-6 mb-12">
                                            <div class="checkout__input--list">
                                                <label>
                                                    <input class="checkout__input--field border-radius-5" placeholder="Zip code"  type="text" name="zipcode">
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="checkout__content--step__footer d-flex align-items-center">
                                <button class="continue__shipping--btn primary__btn border-radius-5" type="submit" name="submit" href="checkout-2.html">Place Order</button>
                            ...
                            <tbody class="cart__table--body">
                                ...
                                <tr class="cart__table--body__items">
                                    <td class="cart__table--body__list">
                                        <div class="product__image two  d-flex align-items-center">
                                            <div class="product__thumbnail border-radius-5">
                                                <a href="product-details.html"><img class="border-radius-5" src="assets/img/product/<?=$item['image'];?>" alt="cart-product"></a>
                                                <span class="product__thumbnail--quantity"><?php echo $item["qty"];?></span>
                                            </div>
                                            <div class="product__description">
                                                <h3 class="product__description--name h4"><a href="product-details.html"><?php echo $item["name"];?></a></h3>
                                                <span class="product__description--variant">COLOR: Blue</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="cart__table--body__list">
                                        <span class="cart__price"><?php echo $item["price"];?></span>
                                    </td>
                                </tr>
                                <?php } }else{ ?>
                    ...
                    <div class="checkout__total">
                        <table class="checkout__total--table">
                            <tbody class="checkout__total--body">
                                <tr class="checkout__total--items">
                                    <td class="checkout__total--title text-left">Subtotal </td>
                                    <td class="checkout__total--amount text-right"><?php echo $cart->total(); ?></td>
                                </tr>
                                <tr class="checkout__total--items">
                                    <td class="checkout__total--title text-left">Shipping</td>
                                    <td class="checkout__total--calculated__text text-right">Calculated at next step</td>
                            ...
                            <tfoot class="checkout__total--footer">
                                <tr class="checkout__total--footer__items">
                                    <td class="checkout__total--footer__title checkout__total--footer__list text-left">Total </td>
                                    <td class="checkout__total--footer__amount checkout__total--footer__list text-right"><?php echo $cart->total(); ?></td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>
